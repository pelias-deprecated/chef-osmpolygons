...
default[:osmpolygons][:setup][:outputdir][:planet] = "#{node[:osmpolygons][:setup][:outputdir]}/planet"
default[:osmpolygons][:setup][:outputdir][:slices] = "#{node[:osmpolygons][:setup][:outputdir]}/slices"
